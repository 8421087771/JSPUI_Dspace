...
%>
    ...
    <body>
        ...
        <table class="pageBanner" width="100%" border="0" cellpadding="0" cellspacing="0">
            ...
            <tr>
                <td>
                    <a href="<%= request.getContextPath() %>/"><img src="<%= request.getContextPath() %>/image/dspace-blue.png" alt="<fmt:message key="jsp.layout.header-default.alt"/>" width="198" height="79" border="0"/></a></td>
